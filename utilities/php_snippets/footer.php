    ...
    <div class="footer-box newsletter-box">
      ...
      <div class="email-box">
        <form class="newsletter-form">
          <input class="email-input" type="email" name="newsletter_email" placeholder="Get notified...">
          <button class="email-btn" type="submit">
            <svg class="email-icon" width="41" height="33" viewBox="0 0 41 33" fill="none" xmlns="http://www.w3.org/2000/svg">
